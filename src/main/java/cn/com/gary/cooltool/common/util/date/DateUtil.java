package cn.com.gary.cooltool.common.util.date;
...
public class DateUtil {
     ...
     * @return 新日期字符串
     */
    public static String convertDateFormat(String date, String olddPattern,
                                           String newPattern) {
     ...
     * @return 新日期字符串
     */
    public static String convertDateFormat(String date, DateStyle olddDteStyle,
                                           String newParttern) {
        String dateString = null;
        if (olddDteStyle != null) {
            dateString = convertDateFormat(date, olddDteStyle.getValue(),
                    newParttern);
        }
        return dateString;
    }
    ...
    public static String convertDateFormat(String date, String olddPattern,
        ...
        if (newDateStyle != null) {
            dateString = convertDateFormat(date, olddPattern,
    ...
    public static void main(String[] args) {
        System.out.println(transferLongToDate("yyyy-MM-dd HH:mm:ss", 1526031610000L));
        System.out.println(transferLongToDate("yyyy-MM-dd HH:mm:ss", 1526031603000L));
        System.out.println(transferLongToDate("yyyy-MM-dd HH:mm:ss", 1526031629000L));
    }
}